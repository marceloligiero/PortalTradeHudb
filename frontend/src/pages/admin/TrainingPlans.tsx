                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          ...
                          {plan.banks && plan.banks.length > 0 ? (
                            plan.banks.slice(0, 2).map(bank => (
                              <span key={bank.id} className="font-body text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                                <Building2 className="w-3 h-3" />
                                {bank.name}
                              </span>
                            ))
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="font-mono text-sm font-bold text-gray-900 dark:text-white">{plan.total_courses} {t('planCard.courses')}</p>
