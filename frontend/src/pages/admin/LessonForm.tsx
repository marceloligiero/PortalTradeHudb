              ...
              {([
                ...
                return (
                  ...
                  >
                    ...
                    <opt.Icon className="w-4 h-4 text-gray-500 dark:text-gray-400" />
        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  min={1}
                  className={`w-20 px-3 py-2.5 bg-white dark:bg-gray-900 border rounded-lg text-sm text-gray-900 dark:text-white text-center focus:ring-2 focus:ring-[#EC0000]/20 focus:border-[#EC0000]/40 transition-colors ${
                    errors.estimated_minutes ? 'border-red-400 dark:border-red-500' : 'border-gray-200 dark:border-gray-700'
                  }`}
                />
                <span className="text-sm text-gray-400">{t('lessons.minutes')}</span>
              </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className="w-20 px-3 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-500 dark:text-gray-400 text-center">
                  {form.order_index}
                </div>
                <span className="text-xs text-gray-400">{t('lessons.orderAutomatic')}</span>
              </div>
            </div>
          </div>
        </div>
