...
import {
  ...
  Filter, BarChart3,
  Target, Activity, Award, GraduationCap,
...
export default function TrainerReportsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-body text-xs font-bold uppercase tracking-widest text-[#EC0000]">
                {t('trainerReports.title')}
              </p>
              <h1 className="font-headline text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">
                {t('trainerReports.title')}
              </h1>
              <p className="font-body text-sm text-gray-500 dark:text-gray-400 mt-1">{t('trainerReports.subtitle')}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-body text-xs text-gray-500 dark:text-gray-400">{t('trainerReports.totalPlans')}</p>
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{overview.total_plans}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-body text-xs text-gray-500 dark:text-gray-400">{t('trainerReports.totalStudents')}</p>
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{overview.total_students}</p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-body text-xs text-gray-500 dark:text-gray-400">{t('courses.title')}</p>
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{overview.total_courses}</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-body text-xs text-gray-500 dark:text-gray-400">{t('trainerReports.lessons')}</p>
              ...
              <Clock className="w-5 h-5 text-[#EC0000]" />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-body text-xs text-gray-500 dark:text-gray-400">{t('certificates.title')}</p>
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{overview.certificates_issued}</p>
              </div>
      ...
      {/* Tab Navigation */}
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-1.5 flex gap-1">
        {[
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-800 rounded-lg text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#EC0000]/30"
              >
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredPlans.map((plan) => (
                    <tr key={plan.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        {plan.bank_code ? (
                          <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg text-sm border border-gray-200 dark:border-gray-700">
      ...
      {activeTab === 'students' && (
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
          <div className="flex items-center gap-2 mb-6">
            <Activity className="w-5 h-5 text-[#EC0000]" />
              ...
              <table className="w-full">
                ...
                <tbody>
                  {studentReports.map((student) => (
                    <tr key={student.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-lg bg-[#EC0000] flex items-center justify-center flex-shrink-0">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          <div className="flex-1 bg-gray-200 dark:bg-gray-800 rounded-full h-2 max-w-[120px]">
                            <div
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
          ...
          {lessonReport && lessonReport.total_lessons > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-800 text-center">
                <BookOpen className="w-10 h-10 text-[#EC0000] mx-auto mb-3" />
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white">{lessonReport.total_lessons}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('trainerReports.totalLessons', 'Total de Modulos')}</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-800 text-center">
                <Clock className="w-10 h-10 text-[#EC0000] mx-auto mb-3" />
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  {t('trainerReports.totalDuration', 'Duracao Total')} ({lessonReport.total_duration_minutes} min)
                </p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-800 text-center">
                <CheckCircle className="w-10 h-10 text-[#EC0000] mx-auto mb-3" />
                <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white">{lessonReport.lessons_per_course}</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t('trainerReports.lessonsPerCourse', 'Modulos por Curso')}</p>
              </div>
            </div>
          ) : (
            <div className="text-center py-12">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{challengeReport.summary.total_submissions}</p>
                  <p className="text-xs text-gray-400 mt-1">
                    {challengeReport.summary.total_challenges} {t('trainerReports.challengesCreated')}
                  </p>
                </div>
                <Swords className="w-5 h-5 text-[#EC0000]" />
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{challengeReport.summary.approval_rate}%</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{challengeReport.summary.avg_mpu}</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="font-mono text-2xl font-bold text-gray-900 dark:text-white mt-1">{challengeReport.summary.error_rate}%</p>
                  <p className="text-xs text-gray-400 mt-1">
                ...
                <div className="flex flex-col justify-center space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-3">
                      <div className="bg-amber-500 h-3 rounded-full transition-all" style={{ width: `${getErrorPercentages(challengeReport.error_breakdown).methodology}%` }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-3">
                      <div className="bg-blue-500 h-3 rounded-full transition-all" style={{ width: `${getErrorPercentages(challengeReport.error_breakdown).knowledge}%` }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-3">
                      <div className="bg-purple-500 h-3 rounded-full transition-all" style={{ width: `${getErrorPercentages(challengeReport.error_breakdown).detail}%` }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-800 rounded-full h-3">
                      <div className="bg-rose-500 h-3 rounded-full transition-all" style={{ width: `${getErrorPercentages(challengeReport.error_breakdown).procedure}%` }} />
                    </div>
                  </div>
                    ...
                    >
                      <div className="flex items-center gap-4 flex-1 min-w-0">
                        <div className="flex-shrink-0">
                          <div className="w-9 h-9 rounded-lg bg-[#EC0000] flex items-center justify-center">
                            <span className="text-white font-bold text-sm">
