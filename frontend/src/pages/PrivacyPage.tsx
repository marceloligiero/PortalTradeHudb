...
export default function PrivacyPage() {
  ...
  const sections = [
    { titleKey: 'dataCollection', contentKey: 'dataCollectionContent' },
    { titleKey: 'dataUsage', contentKey: 'dataUsageContent' },
    { titleKey: 'dataStorage', contentKey: 'dataStorageContent' },
    { titleKey: 'dataSharing', contentKey: 'dataSharingContent' },
    { titleKey: 'userRights', contentKey: 'userRightsContent' },
    { titleKey: 'cookies', contentKey: 'cookiesContent' },
    { titleKey: 'contact', contentKey: 'contactContent' },
  ];
