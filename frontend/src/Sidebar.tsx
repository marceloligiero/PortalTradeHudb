import { Home, BookOpen, Award, Users, Settings, Building2, Package, GraduationCap, BarChart3, Target, Presentation, ClipboardCheck, Star } from 'lucide-react';
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-white/80 dark:bg-[#0a0a0a]/50 backdrop-blur-2xl border-r border-gray-200 dark:border-white/5 min-h-[calc(100vh-80px)] sticky top-20 print:hidden">
