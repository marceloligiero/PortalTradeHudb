...
start "Backend - Port 8000" cmd /k "cd /d c:\Portal Trade DataHub\backend && python main.py"
timeout /t 5 /nobreak >nul

start "Frontend - Port 5173" cmd /k "cd /d c:\Portal Trade DataHub\frontend && npm run dev"
