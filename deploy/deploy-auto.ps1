...
Write-Host "Deploy Automatico - Portal TradeHub VPS" -ForegroundColor Cyan  
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
$commands | Out-File -FilePath temp-deploy.sh -Encoding UTF8
scp temp-deploy.sh root@72.60.188.172:/tmp/deploy.sh
ssh root@72.60.188.172 "chmod +x /tmp/deploy.sh; /tmp/deploy.sh"
